...
const {
    getDogs,createDog,getTemperaments,getDogsAndSave,getDogById,getAllDogs,deleteDog,getDogsBD,
} = require ("./actions.js");
...
router.get("/dogs", async (req, res) => {
  ...
  //filtra y trae todo la info por id
  router.get("/dogs/:id", async (req, res) => {
    //busca el id y trae la informacion, si no lo encuentra debe retornar 404 sino indica un mensaje que dice ID not found
    try {
      let { id } = req.params;
